...
<body>
    ...
    <div class="container">
        ...
        <table class="table-custom">
            <thead><tr><th>Destination precise</th><th>Montant</th><th>Debut prevu</th><th>Fin prevue</th><th>Part client</th><th>Part Maisha Bora</th><th>Part tiers</th></tr></thead>
            <tbody>
                @for($i = 0; $i < 5; $i++)
