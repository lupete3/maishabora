<div>
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-md-6">
                <input type="text" class="form-control" placeholder="Rechercher (code, intitulé)..." wire:model.live="search">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <button class="btn btn-sm btn-warning float-end" wire:click="exportPdf" wire:loading.attr="disabled">
    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">{{ $row['solde_debiteur'] > 0 ? number_format($row['solde_debiteur'], 2, ',', ' ') : '' }}</td>
                <td class="text-end">{{ $row['solde_crediteur'] > 0 ? number_format($row['solde_crediteur'], 2, ',', ' ') : '' }}</td>
            </tr>
            @empty
            <tr>
