                    ...
                    <tr>
                        <td class="ps-3">
                            <div class="d-flex flex-column">
                                <span class="fw-bold text-primary">#{{ $d['credit_id'] }} - {{ $d['member_code'] }}</span>
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                ...
                                <small class="text-muted" style="font-size: 0.7rem;">{{ $d['penalty_percentage'] }}%</small>
                            </div>
                        </td>
                        ...
                        <td class="text-center small pe-3">{{ $d['range_7'] ? number_format($d['range_7'], 0) : '-' }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="13" class="text-center py-4 text-muted small">Aucun crédit en retard découvert.</td>
                    </tr>
                @endforelse
            </tbody>
