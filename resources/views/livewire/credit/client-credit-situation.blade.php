    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="tab-content" id="creditTabsContent">
                <div class="tab-pane fade show active" id="encourscredit" role="tabpanel"
                    aria-labelledby="encourscredit-tab">
                    <div class="row">
                ...
                <div class="tab-pane fade" id="cloturescredit" role="tabpanel"
                                ...
                                <tbody>
                                    ...
                                    @forelse($selectedCredit->repayments->sortBy('due_date') as $r)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ number_format($r->total_due - $r->paid_amount, 2) }}</td>
                                            <td>
                                                @if ($r->is_paid)
                                                    <span class="badge bg-success">Payé</span>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="10" class="text-center">Aucune échéance trouvée.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
