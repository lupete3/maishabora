...
<style>
    .nav-tabs .nav-link.active {
        background-color: #f6a61cda;   /* bleu Bootstrap */
        color: #fff;
                    ...
                    <ul class="nav nav-tabs" id="membreTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="infos-tab" data-bs-toggle="tab" data-bs-target="#infos"
                                type="button" role="tab">Infos de base</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="identite-tab" data-bs-toggle="tab" data-bs-target="#identite"
                                type="button" role="tab">Identité & État civil</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="reference-tab" data-bs-toggle="tab" data-bs-target="#reference"
                                type="button" role="tab">Références & Localisation</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-pane fade show active" id="infos" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-8 mb-1">
                                    ...
                                    <input type="text" wire:model.defer="adresse_physique" id="adresse_physique" class="form-control">
                        ...
                        <div class="tab-pane fade" id="identite" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="date" wire:model.defer="date_expiration_piece" class="form-control">
                                </div>
                                <div class="col-md-6 mb-1">
                        ...
                        <div class="tab-pane fade" id="eco" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <input type="text" wire:model.defer="telephone_conjoint" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="reference" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" wire:model.defer="telephone_reference" class="form-control">
                                </div>
                                <div class="col-md-6 mb-1">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="niveau_etude" wire:model.defer="province" class="form-control">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="niveau_etude" wire:model.defer="commune" class="form-control">
                        ...
                        <div class="tab-pane fade" id="media" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="file" wire:model="photo_profil" class="form-control" accept="image/*">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $photo_profil_url) }}" class="img-thumbnail"
                                            style="max-width: 200px;">
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <img src="{{ asset('storage/' . $scan_piece_url) }}" class="img-thumbnail"
                                            style="max-width: 200px;">
                                        @else
                                        <p><a href="{{ asset('storage/' . $scan_piece_url) }}" target="_blank"><i
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="niveau_etude" wire:model.defer='niveau_etude' class="form-control">
