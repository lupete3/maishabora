...
Route::middleware(['auth', 'check.status', 'auth.session', 'permission:afficher-informations-entreprise'])->group(function () {
...
Route::middleware(['auth', 'check.status', 'auth.session', 'permission:decaissement'])->group(function () {
    Route::get('/gestion-decaissements', [App\Http\Controllers\DisbursementController::class, 'index'])->name('disbursement.index');
});

Route::middleware(['auth', 'check.status', 'auth.session', 'permission:approuver-decaissement'])->group(function () {
...
Route::middleware(['auth', 'check.status', 'auth.session', 'permission:afficher-paye'])->group(function () {
    Route::get('/paie-salarie', [PayrollController::class, 'index'])->name('payroll.index');
});

Route::middleware(['auth', 'check.status', 'auth.session', 'permission:afficher-rapport-comptable'])->group(function () {
